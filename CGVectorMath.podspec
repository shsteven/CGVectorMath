#
#  Be sure to run `pod spec lint CGVectorMath.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "CGVectorMath"
  s.version      = "0.0.1"
  s.summary      = "CGVector math additions. Prefixed with ZS_."

  s.description  = <<-DESC
                   A longer description of CGVectorMath in Markdown format.
  ...
  s.source       = { :git => "https://github.com/shsteven/CGVectorMath.git", :tag => "0.0.1" }
